  ...
  return (
    <div className="sidebar flexbox">
        ...
        <div className="cartalog-div">
            ...
            <div className="add-cart"><p className="cart-destroy">Destroy</p><p className="info">?</p></div>
            <div className="add-cart"><p className="cart-text">Text</p><p className="info">?</p></div>
            <div className="add-cart"><p className="cart-copy">Copy</p><p className="info">?</p></div>
            <div className="add-cart"><p className="cart-paste">Paste</p><p className="info">?</p></div>
        </div>
